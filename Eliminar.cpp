...
void lectura()
{
    ...
    ifstream fp("escayserpye.txt"); // LE ASIGNAS A IFSTREAM LA VARIABLE FP
    ...
    while (opcion != 'E') {
                   ...
                   
        {
            ...
            if (opcion == 'C'){                  //          C
                cout << "HOLA" << endl;          //          C
                                                 //          E
            }else if (opcion == 'E'){            //     EN ESTE EJEMPLO HAY 3 CARCATERES EN TU TXT, PERO PUEDES LEERLO HASTA 20 CARACTERES (SI QUIERES) Y NO VA A IMPORTAR PORQUE TU CODIGO CUANDO LEE EL E SE DEBE CERRAR.
                cout << "ADIOS" << endl;   
                break; 
            }
        }
